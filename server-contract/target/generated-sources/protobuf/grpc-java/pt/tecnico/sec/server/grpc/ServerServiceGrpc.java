...
public final class ServerServiceGrpc {
  ...
  public static final String SERVICE_NAME = "pt.tecnico.sec.server.grpc.ServerService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<pt.tecnico.sec.server.grpc.Server.PingRequest,
      pt.tecnico.sec.server.grpc.Server.PingResponse> getPingMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "ping",
      requestType = pt.tecnico.sec.server.grpc.Server.PingRequest.class,
      responseType = pt.tecnico.sec.server.grpc.Server.PingResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<pt.tecnico.sec.server.grpc.Server.PingRequest,
      pt.tecnico.sec.server.grpc.Server.PingResponse> getPingMethod() {
    io.grpc.MethodDescriptor<pt.tecnico.sec.server.grpc.Server.PingRequest, pt.tecnico.sec.server.grpc.Server.PingResponse> getPingMethod;
      ...
      synchronized (ServerServiceGrpc.class) {
        if ((getPingMethod = ServerServiceGrpc.getPingMethod) == null) {
          ServerServiceGrpc.getPingMethod = getPingMethod =
              io.grpc.MethodDescriptor.<pt.tecnico.sec.server.grpc.Server.PingRequest, pt.tecnico.sec.server.grpc.Server.PingResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "ping"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  pt.tecnico.sec.server.grpc.Server.PingRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  pt.tecnico.sec.server.grpc.Server.PingResponse.getDefaultInstance()))
  ...
  public static abstract class ServerServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void ping(pt.tecnico.sec.server.grpc.Server.PingRequest request,
        io.grpc.stub.StreamObserver<pt.tecnico.sec.server.grpc.Server.PingResponse> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                pt.tecnico.sec.server.grpc.Server.PingRequest,
                pt.tecnico.sec.server.grpc.Server.PingResponse>(
                  this, METHODID_PING)))
          .build();
    }
  }
  ...
  public static final class ServerServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<ServerServiceBlockingStub> {
    ...
    /**
     */
    public pt.tecnico.sec.server.grpc.Server.PingResponse ping(pt.tecnico.sec.server.grpc.Server.PingRequest request) {
  ...
  public static final class ServerServiceFutureStub extends io.grpc.stub.AbstractFutureStub<ServerServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<pt.tecnico.sec.server.grpc.Server.PingResponse> ping(
        pt.tecnico.sec.server.grpc.Server.PingRequest request) {
  ...
  private static final class MethodHandlers<Req, Resp> implements
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_PING:
          serviceImpl.ping((pt.tecnico.sec.server.grpc.Server.PingRequest) request,
              (io.grpc.stub.StreamObserver<pt.tecnico.sec.server.grpc.Server.PingResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class ServerServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return pt.tecnico.sec.server.grpc.Server.getDescriptor();
    }
